...
class HomeController extends Controller
{
  ...
  public function tailwind(Type $var = null)
  {
    return view('tailwind.index');
  }

  public function menuArtikel(Type $var = null)
  {
    return view('tailwind.article');
  }

  public function detailArtikel(Type $var = null)
  {
    return view('tailwind.detail');
  }
  public function blank(Type $var = null)
  {
    return view('tailwind.main');
  }
  ...
  public function field2()
  {
    try {
      ...
      return view('public.kepegawaian.sekretariat', compact('fetch'));
    } catch (\Exception $e) {
      $error = $e->getMessage();
      return redirect()->back()->with(['error' => $error]);;
    }
