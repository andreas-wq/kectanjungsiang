    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="mainNavigation">
        <ul class="navbar-nav mr-30 ml-30 mr-auto">
          ...
          <li class="nav__item">
            <a href="{{route('public.field2')}}"  class="nav__item-link {{ Request::routeIs('public.skretariat.*')||Request::routeIs('public.skretariat.*') ? 'active' : '' }}">Sekretariat</a>
          </li>
      </li><!-- /.nav-item -->
          <li class="nav__item with-dropdown">
            ...
            <li class="nav__item">
            <a href="https://play.google.com/store/apps/details?id=id.go.subang.laporkang" class="nav__item-link {{ Request::routeIs('public.contact') ? 'active' : '' }}">Pengaduan</a>
          </li><!-- /.nav-item -->
        </ul><!-- /.navbar-nav -->
      </div><!-- /.navbar-collapse -->
