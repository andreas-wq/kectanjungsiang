          ...
          <div class="flex flex-wrap">
            <div class=" w-full   justify-center">
              <div class="mb-12 p-4">
                  {{-- artikel detail --}}
                  <div class="img">
                    <img src="{{($profil->img)? asset('/storage/profile/images/'.$profil->img) : asset('backend/img/default.png')}}" alt="blog image" class="w-full rounded-lg shadow-lg">
                  </div>
                  <div class="flex mt-3">
                    <p class="font-thin text-xs lg:font-medium text-secondary mb-1 flex">
                      <span>   <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16"><path fill="none" d="M0 0h24v24H0z"/><path d="M4 22a8 8 0 1 1 16 0H4zm8-9c-3.315 0-6-2.685-6-6s2.685-6 6-6 6 2.685 6 6-2.685 6-6 6z"/></svg> </span><span class="flex"> &nbsp;&nbsp; {{$profil->created_by}} &nbsp;&nbsp; </span>
                    </p>
                    <p class="font-thin text-xs lg:font-medium text-secondary mb-1 flex">
                      <span><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16"><path fill="none" d="M0 0h24v24H0z"/><path d="M9 1v2h6V1h2v2h4a1 1 0 0 1 1 1v16a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h4V1h2zm11 9H4v9h16v-9zm-4.964 1.136l1.414 1.414-4.95 4.95-3.536-3.536L9.38 12.55l2.121 2.122 3.536-3.536zM7 5H4v3h16V5h-3v1h-2V5H9v1H7V5z"/></svg></span> &nbsp;&nbsp; 	{{\Carbon\Carbon::parse($profil->created_at)->translatedFormat('l, d F Y')}}
                    </p>
                  </div>
                  ...
                  <h3 class="text-primary truncate text-xl font-semibold mt-3">{{ $profil->title }}</h3>
                  <p class="text-secondary mb-4 mt-3">   {!!$profil->description !!} </p>
        ...
        <div class="w-full lg:w-1/3  p-10 rounded-lg shadow-lg bg-slate-300">
          <aside class="sidebar sidebar-wide">
            <div class="widget widget-posts  my-10">
              <h5 class="widget__title text-xl font-lora mb-5">Agenda Terbaru</h5>
