              ...
              <div class="card card-success">
                ...
                <form id="quickForm" action="{{route('admin.field.update')}}" method="post" enctype="multipart/form-data">
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      <label for="status">Kelompok Unit</label>
                      <div class="select2-green">
                        <select class="form-control select2bs4" name="kelompok" style="width: 100%;">
                          <option value="1" @if($fetch->kelompok == "1") selected @else "" @endif >Sekretariat</option>
                          <option value="2" @if($fetch->kelompok == "2") selected @else "" @endif>Bidang</option>
                        </select>
                      </div>
                    </div>
                    <div class="form-group">
