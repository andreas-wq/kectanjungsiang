            ...
            >
              <ul class="block lg:flex">
                ...
                <li class="group relative">
                  ...
                  >
                  <ul
                    class="submenu absolute py-1 bg-white shadow-lg rounded-lg max-w-[250px] right-4 text-left z-[1000]"
                  >
        ...
        <!-- <div class="flex flex-wrap"> -->
          <div class="w-full lg:w-l/2 self-center">
            <div class="flex flex-wrap">
                  ...
                  <div class="flex flex-wrap">
                    ...
                    class="w-full lg:w-1/3 bg-white rounded-xl shadow-lg overflow-hidden m-[30px]"  >
                      ...
                      <div class="py-8 px-6">
                        ...
                        <p class="font-thin text-xs lg:font-medium text-secondary mb-0 flex">
                          <span>   <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="9" height="9"><path fill="none" d="M0 0h24v24H0z"/><path d="M4 22a8 8 0 1 1 16 0H4zm8-9c-3.315 0-6-2.685-6-6s2.685-6 6-6 6 2.685 6 6-2.685 6-6 6z"/></svg> </span> &nbsp;&nbsp; admin 
                        </p>
                        <p class="font-thin text-xs lg:font-medium text-secondary mb-0 flex">
                          <span><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="8" height="8"><path fill="none" d="M0 0h24v24H0z"/><path d="M9 1v2h6V1h2v2h4a1 1 0 0 1 1 1v16a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h4V1h2zm11 9H4v9h16v-9zm-4.964 1.136l1.414 1.414-4.95 4.95-3.536-3.536L9.38 12.55l2.121 2.122 3.536-3.536zM7 5H4v3h16V5h-3v1h-2V5H9v1H7V5z"/></svg></span> &nbsp;&nbsp; 	 Rabu, 06 April 2022
                        </p>
                        <p class="font-thin text-xs lg:font-medium text-secondary mb-0 flex">
                        <span> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="8" height="8"><path fill="none" d="M0 0h24v24H0z"/><path d="M1.181 12C2.121 6.88 6.608 3 12 3c5.392 0 9.878 3.88 10.819 9-.94 5.12-5.427 9-10.819 9-5.392 0-9.878-3.88-10.819-9zM12 17a5 5 0 1 0 0-10 5 5 0 0 0 0 10zm0-2a3 3 0 1 1 0-6 3 3 0 0 1 0 6z"/></svg></span> &nbsp;&nbsp;   31
                        </p>
              ...
              <div class="w-full lg:w-1/3 h-30 mx-auto text-left">
           
                  <div class="filter h-[531px] w-full bg-slate-300 rounded-lg p-7">
                    <div id="arsip"clas= "w-full h-1/3 ">
                      <h1 class="text-xl text-dark underline font-bold">Arsip</h1>
                      <div class="grid grid-cols-2 gap-2">
                        <div>  <p class="text-dark m-2">2022 / April</p></div>
                        <!-- ... -->
                        <div> <span class="bg-primary p-1 rounded-full text-right text-white">3</span></div>
                        <div>  <p class="text-dark m-2">2022 / April</p></div>
                        <!-- ... -->
                        <div> <span class="bg-primary p-1 rounded-full text-right text-white">3</span></div>
                      </div>
                      ...
                      <h1 class="text-xl text-dark underline font-bold mt-5">Category</h1>
                      <div class="grid grid-cols-2 gap-2">
                        <div>  <p class="text-dark m-2">2022 / April</p></div>
                        <!-- ... -->
                        <div> <span class="bg-primary p-1 rounded-full text-right text-white">3</span></div>
        ...
        <div class="flex flex-wrap">
          <div class="w-1/2  mt-10  px-4">
            ...
            <p class="font-thin text-xs lg:font-medium text-white mb-0 flex">
              <span><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="15" height="15"><path fill="none" d="M0 0h24v24H0z"/><path d="M21 16.42v3.536a1 1 0 0 1-.93.998c-.437.03-.794.046-1.07.046-8.837 0-16-7.163-16-16 0-.276.015-.633.046-1.07A1 1 0 0 1 4.044 3H7.58a.5.5 0 0 1 .498.45c.023.23.044.413.064.552A13.901 13.901 0 0 0 9.35 8.003c.095.2.033.439-.147.567l-2.158 1.542a13.047 13.047 0 0 0 6.844 6.844l1.54-2.154a.462.462 0 0 1 .573-.149 13.901 13.901 0 0 0 4 1.205c.139.02.322.042.55.064a.5.5 0 0 1 .449.498z"/></svg></span> &nbsp;&nbsp; (0260) 4113251 / 421910
            </p>
            <p class="font-thin text-xs lg:font-medium text-white mb-0 flex">
              <span><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="15" height="15"><path fill="none" d="M0 0h24v24H0z"/><path d="M3 3h18a1 1 0 0 1 1 1v16a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1zm17 4.238l-7.928 7.1L4 7.216V19h16V7.238zM4.511 5l7.55 6.662L19.502 5H4.511z"/></svg></span> &nbsp;&nbsp; disketpan@subang.go.id
            </p>
            <p class="font-thin text-xs lg:font-medium text-white mb-0 flex">
              <span><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="15" height="15"><path fill="none" d="M0 0h24v24H0z"/><path d="M2 5l7-3 6 3 6.303-2.701a.5.5 0 0 1 .697.46V19l-7 3-6-3-6.303 2.701a.5.5 0 0 1-.697-.46V5zm14 14.395l4-1.714V5.033l-4 1.714v12.648zm-2-.131V6.736l-4-2v12.528l4 2zm-6-2.011V4.605L4 6.319v12.648l4-1.714z"/></svg></span> &nbsp;&nbsp;    Jalan Palabuan No 11 Sukamelang Subang
            </p>
          ...
          <div class="w-1/2  mt-10  px-4">
            <div class="relative ">
              ...
              <p class="font-thin text-xs lg:font-medium text-white mb-0 flex">
                <span><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="15" height="15"><path fill="none" d="M0 0h24v24H0z"/><path d="M6.235 6.453a8 8 0 0 0 8.817 12.944c.115-.75-.137-1.47-.24-1.722-.23-.56-.988-1.517-2.253-2.844-.338-.355-.316-.628-.195-1.437l.013-.091c.082-.554.22-.882 2.085-1.178.948-.15 1.197.228 1.542.753l.116.172c.328.48.571.59.938.756.165.075.37.17.645.325.652.373.652.794.652 1.716v.105c0 .391-.038.735-.098 1.034a8.002 8.002 0 0 0-3.105-12.341c-.553.373-1.312.902-1.577 1.265-.135.185-.327 1.132-.95 1.21-.162.02-.381.006-.613-.009-.622-.04-1.472-.095-1.744.644-.173.468-.203 1.74.356 2.4.09.105.107.3.046.519-.08.287-.241.462-.292.498-.096-.056-.288-.279-.419-.43-.313-.365-.705-.82-1.211-.96-.184-.051-.386-.093-.583-.135-.549-.115-1.17-.246-1.315-.554-.106-.226-.105-.537-.105-.865 0-.417 0-.888-.204-1.345a1.276 1.276 0 0 0-.306-.43zM12 22C6.477 22 2 17.523 2 12S6.477 2 12 2s10 4.477 10 10-4.477 10-10 10z"/></svg></span> &nbsp;&nbsp; Pengguna Online :
              </p>
              <p class="font-thin text-xs lg:font-medium text-white mb-0 flex">
                <span><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="15" height="15"><path fill="none" d="M0 0h24v24H0z"/><path d="M20 22H4v-2a5 5 0 0 1 5-5h6a5 5 0 0 1 5 5v2zm-8-9a6 6 0 1 1 0-12 6 6 0 0 1 0 12z"/></svg></span> &nbsp;&nbsp; Pengunjung Hari Ini	:	 
              </p>
              <p class="font-thin text-xs lg:font-medium text-white mb-0 flex">
              <span><svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="black" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-users"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg></span> &nbsp;&nbsp;    Total Pengunjung	:
              </p>
