...
<section id="slider3" class="slider slider-3 text-le">
  <div class="carousel owl-carousel carousel-arrows carousel-dots" data-slide="1" data-slide-md="1" data-slide-sm="1" data-autoplay="true" data-nav="true" data-dots="true" data-space="0" data-loop="true" data-speed="500">
    @if(count($slider) > 0)
...
<!-- === Pengumuman ===  -->
<section id="testimonial4" class="testimonial testimonial-1 testimonial-4 testimonial-white-text bg-overlay bg-overlay-3 bg-parallax text-center pt-100 pb-100">
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-sm-12 col-md-12 col-lg-10 offset-lg-1">
        <div class="carousel owl-carousel carousel-arrows" data-slide="1" data-slide-md="1" data-slide-sm="1" data-autoplay="true" data-nav="true" data-dots="false" data-space="0" data-loop="true" data-speed="500">
          <!-- pengumuman -->
          ...
          <div>
            <span style="font-weight:bold;">
              <h4 style="color:#fff;">- Belum ada data -</h4>
            </span>
          </div>
          @endif
        </div>
        ...
        <div class="card mx-4 my-2 shadow">
          <div class="member">
            <div class="member__img">
              <img src="{{($pegawai->photo) ? asset('/storage/staff/images/'.$pegawai->photo) : asset('backend/img/default.png')}}" height="340px" width="180px" alt="{{$pegawai->name}}">
              ...
              <div class="member__content shadow-sm">
                <div class="member__content-inner">
                  <div class="member__info">
                    ...
                    <p class="member__desc">{{$pegawai->position}}</p>
                    <hr>
