...
@section('content')
  ...
  <section id="page-title" class="page-title page-title-layout1  text-center">
    <div class="bg-img"><img src="{{asset('frontend/images/page-titlesDLH.png')}}" alt="background"></div>
    <div class="container">
      <div class="row">
        <div class="col-sm-12 col-md-12 col-lg-12">
          <h1 class="pagetitle__heading text-dark">{{$profil->title}}</h1>
        </div><!-- /.col-lg-12 -->
      </div><!-- /.row -->
    </div><!-- /.container -->
  </section><!-- /.page-title -->
        ...
        <div class="blog-item blog-single-item">
          ...
          <div class="blog__content">
            ...
            <div class="blog__desc">
              {!!$profil->description !!}
                @if($profil->file)
                    <iframe src="{{asset('/storage/profile/files/'.$profil->file)}}" frameborder="0" width="100%" height="600px"></iframe>  
                    @endif  
            </div><!-- /.blog-desc -->
          </div><!-- /.entry-content -->
        </div><!-- /.blog-item -->
