...
Route::namespace('Frontend')->group(static function () {
    ...
    Route::get('/menu-artikel', 'HomeController@menuArtikel')->name('public.menuArtikel');
    Route::get('/detail-artikel', 'HomeController@detailArtikel')->name('public.deailArtikel');
    Route::get('/tailwind', 'HomeController@tailwind')->name('public.tailwind');
    Route::get('/blank', 'HomeController@blank')->name('public.blank');
    ...
    Route::get('/kepegawaian/sekretariat', 'HomeController@field2')->name('public.field2');
